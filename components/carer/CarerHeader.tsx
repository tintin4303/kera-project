...
import { carerNavigation } from './CarerSidebar';

export default function CarerHeader() {
            ...
            <header className="bg-white shadow-sm border-b border-gray-200 md:hidden sticky top-0 z-40">
                <div className="flex items-center justify-between h-14 px-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-lg font-bold text-gray-900">KERA Carer</h1>
                    </div>
